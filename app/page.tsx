...
export default function Page() {
  return (
    <section>
      <h1 className="mb-8 text-2xl font-semibold tracking-tighter"> {'Hi, Willow here. I&apos;m an ex-PM, now designing digital experiences that feel natural and intentional.'}
      </h1>
      <p className="mb-4">
